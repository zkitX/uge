...
namespace uge::dbg
{
    ...
    class CORESYSTEM_API CStackTrace
    {
    private:
        enum
        {
            MAX_STACK_TRACE_FRAMES = 128,
            MAX_FILENAME_LEN = 256,
            MAX_FUNCNAME_LEN = 256
        };
        struct AddressInfo
        {
...
extern CORESYSTEM_API uge::dbg::CAssert g_assert;
extern CORESYSTEM_API uge::dbg::CTrace g_trace;
